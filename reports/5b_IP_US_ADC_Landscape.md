...
> **Note:** Due to file size (~500 MB), `US-enforced-patents.jsonl` is excluded from the repository. It can be regenerated by re-running the search query above on [The Lens](https://www.lens.org/) and exporting as JSONL.
